...
public class EnemyShooterController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        else if (Vector3.Distance(target.position, transform.position) <= minRange && nextFireTime < Time.time)
        {
            Firing();
        }
    ...
    void Firing()
    {
        Instantiate(projectile, shooterTransform.position, shooterTransform.rotation);
